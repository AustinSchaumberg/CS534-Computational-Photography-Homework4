...
%
% For more information on  steps being performed, please view the section
% above "your code starts here".
H_map(1) = {eye(3)}; 
...
panorama_image = blend(warped_images{4},blend(warped_images{3},...
blend(warped_images{2},warped_images{1})));

%imshow(panorama_image);
imwrite(panorama_image, 'schaumberg2.jpg');
